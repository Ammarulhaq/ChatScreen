...
class ChatScreen : AppCompatActivity(),OnSocketConnectionListener{
        ...
        chatMsg.setOnKeyListener(object : View.OnKeyListener {
            override fun onKey(v: View?, keyCode: Int, event: KeyEvent): Boolean {
                ...
                if (event.action == KeyEvent.ACTION_DOWN && keyCode == KeyEvent.KEYCODE_ENTER && ListMessages!=null) {
                    ...
                    payload.put("message",chatMsg.text)
    ...
    fun LoadMoreMessages(conversationsItem: ConversationsItem,downloadMsgs:Int)
    {
        ...
        WebServicesHandler.instance.loadMoreMessages("eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJjb21wYW55X2lkIjoiMTg4IiwiZW1haWwiOiJoYW1tYWRAd3VycWkuY29tIiwicmVzb3VyY2VfaWQiOjEzMiwiZXhwIjoxNTkyMjg5MjYzfQ.grvM6AGuDQ2-nh5psEq3mvTJtmQ6tlyGZ57aQsToCK8",conversationsItem.conversationId,latestMessage!!.conversationMessageId,downloadMsgs,object : CustomCallback<RetrofitJSONResponse?>()
        {
