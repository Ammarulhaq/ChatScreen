...
class ConversationFragment() : Fragment() , ConversationListingAdapter.OnConversationSelect{
    ...
    {
        WebServicesHandler.instance.getAllConversations("eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJjb21wYW55X2lkIjoiMTg4IiwiZW1haWwiOiJoYW1tYWRAd3VycWkuY29tIiwicmVzb3VyY2VfaWQiOjEzMiwiZXhwIjoxNTkyMjg5MjYzfQ.grvM6AGuDQ2-nh5psEq3mvTJtmQ6tlyGZ57aQsToCK8",object : CustomCallback<RetrofitJSONResponse?>() {
